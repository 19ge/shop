...
// export const APIHost ='http://192.168.1.165:1001';
// export const APIHost ='http://47.92.145.141:2811';
// export const APIHost ='http://csyxadmin.jugekeji.com';
export const APIHost ='https://adminbmx.9efag8.cn';
...
export function loginn(password){
  return HmacMD5(password,password).toString();
}
export function change(username,password){
  store.set("user",{username:username,password:password});
}
// //改手机号
// export function tel(username){
//   store.set("user",{username:username,password:HmacMD5(password,password).toString()});
// }
//登出
